...
const MENU = [
  { id: 1, name: "סביצ'ה דג", price: 65, desc: "..", image: '', color: "from-orange-500 to-orange-700" },
  { id: 2, name: "ברוסקטת גבינות", price: 58, desc: "..", image: '', color: "from-orange-600 to-red-700" },
  { id: 3, name: "ברוסקטת חצילים ופלפלים", price: 28, desc: "...", image: '', color: "from-yellow-500 to-orange-600" },
  { id: 4, name: "פריקסה", price: 28, desc: "..", image: ''},
  { id: 5, name: "קיש בטטה", price: 50, desc:"..", image: ''},
  { id: 6, name: "קיש תפ''א ופטריות", price: 50, desc:"..", image: ''},
  { id: 7, name: "מיני קישים", price: 50, desc:"..", image: ''},
  { id: 8, name: "מיני טורטיה", price: 50, desc:"..", image: ''},
  { id: 9, name: "מיני פוקאצ'ה", price: 50, desc:"..", image: ''},
  { id: 10, name: "מגש לביבות תפ''א", price: 50, desc:"..", image: ''},
  { id: 11, name: "מגש סושי", price: 50, desc:"..", image: ''},
  { id: 12, name: "מגש אנטיפסטי", price: 50, desc:"..", image: ''},
  { id: 13, name: "מגש גבינות מפנק", price: 50, desc:"..", image: ''},
  { id: 14, name: "מיני פיתה סביח", price: 50, desc:"..", image: ''},
  { id: 15, name: "קרואסונים ממולאים גבינת שמנת וסלמון", price: 50, desc:"..", image: ''},
  { id: 16, name: "לחמניות של אמא", price: 50, desc:"לחמניות עבודת יד ממולאות במטבוחה ביתית חצילים מטוגנים ופשטידה.", image: ''},
  { id: 17, name: "קוסקוס של סבתא", price: 50, desc:"..", image: ''},
  { id: 18, name: "פסטה רוזה", price: 50, desc:"..", image: ''},
  { id: 19, name: "פסטה שמנת פטריות", price: 50, desc:"..", image: ''},
  { id: 20, name: "פסטה עם ירקות מוקפצים", price: 50, desc:"..", image: ''},
  { id: 21, name: "שקשוקה", price: 50, desc:"..", image: ''},
  { id: 22, name: "תפו''א מוקרם", price: 50, desc:"..", image: ''},
  { id: 23, name: "תפו''א/בטטה בתנור", price: 50, desc:"..", image: ''}
